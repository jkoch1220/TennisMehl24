...
// Geschäftsprozesse (Organigramm-/Prozess-Boards) + Task-Verwaltung
...
// Weiterleitung alter Board-Links (/planung/:boardId) auf die neue Route
const PlanungBoardRedirect = () => {
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                {/* Geschützte Tool-Routes */}
                  ...
                  <Route path="/geschaeftsprozesse" element={
                    <ProtectedRoute toolId="mindmap">
                      <BoardUebersicht />
                    </ProtectedRoute>
                  } />
                  <Route path="/geschaeftsprozesse/:boardId" element={
                    <ProtectedRoute toolId="mindmap">
                      <Mindmap />
                    </ProtectedRoute>
                  } />
