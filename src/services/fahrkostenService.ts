...
export const fahrkostenService = {
  ...
  buildFahrtPayload(fahrt: Fahrt) {
    return {
      ...
      autoKennzeichen: fahrt.autoKennzeichen || null,
      ...
      startKm: fahrt.startKm ?? null,
      endKm: fahrt.endKm ?? null,
  ...
  berechneFahrt(neueFahrt: NeueFahrt, id: string, jetzt: string): Fahrt {
    ...
    return {
      ...
      autoKennzeichen: neueFahrt.autoKennzeichen,
      ...
      kilometer: km,
      startKm: neueFahrt.startKm,
      endKm: neueFahrt.endKm,
  ...
  async erstelleAuto(auto: Omit<Auto, 'id'>): Promise<Auto> {
    ...
    await databases.createDocument(DATABASE_ID, FAHRTKOSTEN_AUTOS_COLLECTION_ID, id, {
      ...
      name: auto.name,
      kennzeichen: auto.kennzeichen || null,
  ...
  parseFahrtDocument(doc: Record<string, unknown>): Fahrt {
    return {
      ...
      autoKennzeichen: (doc.autoKennzeichen as string) || undefined,
      ...
      startKm: (doc.startKm as number | null) ?? undefined,
      endKm: (doc.endKm as number | null) ?? undefined,
