    ...
    <div className="space-y-6">
          ...
          <div className="mt-6">
            ...
            <div className="space-y-2">
              {lieferkosten.map((berechnung) => (
                ...
                >
                  <div className="flex-1">
                    <div className="font-semibold text-gray-900">{berechnung.konkurrentName}</div>
                    <div className="text-sm text-gray-600 mt-1">{berechnung.berechnungsgrundlage}</div>
                  </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-lg p-4 max-w-xs z-30 pointer-events-none">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Klein (bis 2.000 t/Jahr)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-red-600" />
                <span className="text-gray-600">Mittel (2.000-5.000 t/Jahr)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-red-600" />
                <span className="text-gray-600">Groß (über 5.000 t/Jahr)</span>
              </div>
            </div>
          ...
          {/* Info-Box */}
          <div className="absolute top-4 right-4 bg-white rounded-lg shadow-lg p-4 max-w-xs z-30 pointer-events-none">
        ...
        {konkurrentenTennisSand.length > 0 && (
          <div className="mt-6">
            <h4 className="text-md font-semibold text-gray-900 mb-3">Konkurrenten-Übersicht</h4>
